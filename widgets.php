...
class Custom_WP_Widget_Text extends WP_Widget {

	function Custom_WP_Widget_Text() {
		$widget_ops = array('classname' => 'widget_text', 'description' => __('Custom Arbitrary text or HTML'));
...
class Custom_WP_Widget_Categories extends WP_Widget {
	...
	function Custom_WP_Widget_Categories() {
		$widget_ops = array( 'classname' => 'widget_categories', 'description' => __( "Custom A list or dropdown of categories" ) );
...
<?php
		$cat_args['title_li'] = '';
		custom_wp_list_categories(apply_filters('widget_categories_args', $cat_args));
?>
		</ul>
<?php
		}
...
class Custom_WP_Widget_Tag_Cloud extends WP_Widget {

	function Custom_WP_Widget_Tag_Cloud() {
		$widget_ops = array( 'description' => __( "Custom Your most used tags in cloud format") );
...
class Custom_WP_Widget_Recent_Comments extends WP_Widget {

	function Custom_WP_Widget_Recent_Comments() {
		$widget_ops = array('classname' => 'widget_recent_comments', 'description' => __( 'Custom The most recent comments' ) );
...
<?php
	...
	function widget( $args, $instance ) {
		...
		$output .= '<ul class="comments-list hfeed">';
		if ( $comments ) {
			foreach ( (array) $comments as $comment) {
				$output .=  '<li class="hentry"><blockquote><p><a href="' . esc_url( get_comment_link($comment->comment_ID) ) . '">' . get_the_title($comment->comment_post_ID) . '</a></p></blockquote></li>';
			}
 		}
		$output .= '</ul>';
		$output .= $after_widget;
...
class Custom_WP_Widget_Recent_Posts extends WP_Widget {
	...
	function Custom_WP_Widget_Recent_Posts() {
		$widget_ops = array('classname' => 'widget_recent_entries', 'description' => __( "Custom The most recent posts on your site") );
...
class Custom_WP_Widget_Links extends WP_Widget {
	...
	function Custom_WP_Widget_Links() {
		$widget_ops = array('description' => __( "Custom Your blogroll" ) );
	...
	function widget( $args, $instance ) {
		...
		custom_wp_list_bookmarks(apply_filters('widget_links_args', array(
...
add_action('widgets_init', create_function('', 'return register_widget("Custom_WP_Widget_Text");'));
add_action('widgets_init', create_function('', 'return register_widget("Custom_WP_Widget_Categories");'));
add_action('widgets_init', create_function('', 'return register_widget("Custom_WP_Widget_Tag_Cloud");'));
add_action('widgets_init', create_function('', 'return register_widget("Custom_WP_Widget_Recent_Comments");'));
add_action('widgets_init', create_function('', 'return register_widget("Custom_WP_Widget_Recent_Posts");'));
